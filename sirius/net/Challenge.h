...
#pragma once
#include "sirius/ionet/ConnectionSecurityMode.h"
#include "sirius/ionet/Packet.h"
//#include "sirius/ionet/PacketHandlers.h"
#include "sirius/types.h"

namespace sirius { namespace crypto { class KeyPair; } }
