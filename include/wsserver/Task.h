...
enum Type
{
	...
	ACTION_LIST_CONVERSION_REQUEST,
	ACTION_LIST_CONVERSION_RESPONSE,

	ADD_MODIFICATION_REQUEST,
	ADD_MODIFICATION_RESPONSE,

	ADD_MODIFICATION_FILES_REQUEST,
	ADD_MODIFICATION_FILES_RESPONSE,
