...
#define TEST_NAME SupercontractWriteAndReadInASingleSandbox
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        class WriteAndReadInASingleSandbox {
        ...
        public:
            ...
            WriteAndReadInASingleSandbox(ENVIRONMENT_CLASS& env)
                    : m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            WriteAndReadInASingleSandbox handler(env);
