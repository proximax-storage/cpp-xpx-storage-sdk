...
#define TEST_NAME SupercontractCreateTwoDirectoryAndWriteInFirstDirectory
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            void onDirCreated(std::optional<CreateDirectoriesResponse> res) {
                ASSERT_TRUE(res);
                m_env.openFile(m_driveKey, OpenFileRequest{ OpenFileMode::WRITE, "tests2/test.txt", [this](auto res) { onFileOpened(res); } });
            }
        ...
        class TestWriteInFirstDirectory {
        ...
        public:
            ...
            TestWriteInFirstDirectory(ENVIRONMENT_CLASS& env, std::string buffer)
                : m_env(env), m_buffer(buffer) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestFirstDirectory handler(env, "");
            ...
            TestSecondDirectory handler2(env, "");
            ...
            TestWriteInFirstDirectory handler3(env, "");
