...
#define TEST_NAME SupercontractCreateTwoFileThenDelBothFileAndCreateDirThenCreateBackBothDelFile
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            TestCreateTwoFile(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        public:
            ...
            TestRemoveTwoFile(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        public:
			...
			void onFileRemoved(std::optional<RemoveFilesystemEntryResponse> res) {
				ASSERT_TRUE(res);
				ASSERT_TRUE(res->m_success);
				m_env.removeFsTreeEntry(m_driveKey, RemoveFilesystemEntryRequest{"test2.txt", [this](auto res) {
															onFileRemoved2(res);
														}});
			}
        ...
        class TestCreateDirAndCreateBack {
        ...
        public:
            ...
            TestCreateDirAndCreateBack(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestRemoveTwoFile handler2(env);
            ...
            TestCreateDirAndCreateBack handler3(env);
