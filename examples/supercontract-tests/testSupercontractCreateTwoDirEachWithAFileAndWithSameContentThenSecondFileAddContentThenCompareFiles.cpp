...
#define TEST_NAME SupercontractCreateTwoDirEachWithAFileAndWithSameContentThenSecondFileAddContentThenCompareFiles
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
		...
		class TestSecondFileAddContent {
        ...
        public:
            ...
            TestSecondFileAddContent(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        public:
            ...
            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.openFile(m_driveKey, OpenFileRequest{ OpenFileMode::WRITE, "tests2/test2.txt", [this](auto res) { onFileOpened(res); } });
            }
		...
		public:
			...
			void onFileSize(std::optional<FileSizeResponse> res) {
				...
				m_env.getSize(m_driveKey, FileSizeRequest{"tests2/test2.txt", [this](auto res) {
															   onFileSize2(res);
														   }});
			}
            ...
            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.getSize(m_driveKey, FileSizeRequest{"tests/test.txt", [this](auto res) {
												   onFileSize(res);
											   }});
            }
        ...
        TEST(SupercontractTest, TEST_NAME) {
			...
			TestSecondFileAddContent handler2(env);
			...
			TestCompareFileSize handler3(env);
