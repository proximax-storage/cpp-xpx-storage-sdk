...
#define TEST_NAME SupercontractMoveFileToFolderWithSameFileName
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            TestHandlerCreate2(ENVIRONMENT_CLASS& env)
                    : m_env(env) {}
        ...
        public:
            ...
            void onReceivedFsTree(std::optional<FilesystemResponse> res) {
                ...
                m_env.getAbsolutePath(m_driveKey, FileInfoRequest{"moved/test.txt", [this](auto res) {
                    onReceivedAbsolutePath(res);
                }});
            }
            ...
            void onDirCreated(std::optional<CreateDirectoriesResponse> res) {
                ASSERT_TRUE(res);
                m_env.openFile(m_driveKey, OpenFileRequest{OpenFileMode::WRITE, "moved/test.txt", [this](auto res) { onFileOpened(res); }});
            }
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestHandlerCreate2 handler2(env);
