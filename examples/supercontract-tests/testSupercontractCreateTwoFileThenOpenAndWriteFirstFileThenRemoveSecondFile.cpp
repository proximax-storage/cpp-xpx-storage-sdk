...
#define TEST_NAME SupercontractCreateTwoFileThenOpenAndWriteFirstFileThenRemoveSecondFile
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
		...
		public:
			...
			TestOpenAndWriteFile(ENVIRONMENT_CLASS& env)
				: m_env(env) {}
		...
		public:
            ...
            void onReceivedAbsolutePath(std::optional<FileInfoResponse> res) {
                ...
                stream << fileStream.rdbuf();
                auto content = stream.str();
                ASSERT_EQ(content, "data data data");
				m_env.getAbsolutePath(m_driveKey, FileInfoRequest{ "test2.txt", [this](auto res) {
                                                                          onReceivedAbsolutePath2(res);
                                                                      } });
            }
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestOpenAndWriteFile handler2(env);
