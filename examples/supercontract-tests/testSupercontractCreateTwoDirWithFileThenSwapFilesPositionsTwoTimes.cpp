...
#define TEST_NAME SupercontractCreateTwoDirWithFileThenSwapFilesPositionsTwoTimes
    ...
    namespace {
        ...
        public:
            ...
            void onReceivedAbsolutePath(std::optional<FileInfoResponse> res) {
                ...
                m_env.getAbsolutePath(m_driveKey, FileInfoRequest{ "tests2/test2.txt", [this](auto res) {
            ...
            void onReceivedFsTree(std::optional<FilesystemResponse> res) {
                ...
                for (auto const& [_, child] : fsTree.childs()) {
                    ...
                    if (folder.name() == "tests2") {
                        ASSERT_TRUE(folder.name() == "tests2");
            ...
            void onDirCreated2(std::optional<CreateDirectoriesResponse> res) {
                ASSERT_TRUE(res);
                m_env.openFile(m_driveKey, OpenFileRequest{ OpenFileMode::WRITE, "tests2/test2.txt", [this](auto res) { onFileOpened2(res); } });
            }

            void onFileClosed(std::optional<CloseFileResponse> res) {
                ASSERT_TRUE(res);
                ASSERT_TRUE(res->m_success);
                m_env.createDirectories(m_driveKey, CreateDirectoriesRequest{ "tests2", [this](auto res) { onDirCreated2(res); } });
            }
        ...
        public:
            ...
            TestSwap(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        public:
            ...
            void onReceivedAbsolutePath(std::optional<FileInfoResponse> res) {
                ...
                auto content = stream.str();
                ASSERT_EQ(content, "data data");
                m_env.getAbsolutePath(m_driveKey, FileInfoRequest{ "tests2/test.txt", [this](auto res) {
                                                                          onReceivedAbsolutePath2(res);
                                                                      } });
            }
			...
			void onFileMoved(std::optional<MoveFilesystemEntryResponse> res) {
                ASSERT_TRUE(res);
                ASSERT_TRUE(res->m_success);
				m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{ "tests2/test2.txt", "tests/test2.txt", [this](auto res) { onFileMoved2(res); } });
            }

			void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
				ASSERT_TRUE(res);
				m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{ "tests/test.txt", "tests2/test.txt", [this](auto res) { onFileMoved(res); } });
			}
        ...
        public:
            ...
            TestSwapTwo(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        public:
			...
			void onFileMoved(std::optional<MoveFilesystemEntryResponse> res) {
                ASSERT_TRUE(res);
                ASSERT_TRUE(res->m_success);
				m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{ "tests/test2.txt", "tests2/test2.txt", [this](auto res) { onFileMoved2(res); } });
            }

			void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
				ASSERT_TRUE(res);
				m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{ "tests2/test.txt", "tests/test.txt", [this](auto res) { onFileMoved(res); } });
			}
