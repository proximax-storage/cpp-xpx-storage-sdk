...
#define TEST_NAME SupercontractCreateDirThenDelFileAndMoveFileInOneSandbox
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
		...
		class TestRemoveFileAndMoveFile {
		...
		public:
			...
			TestRemoveFileAndMoveFile(ENVIRONMENT_CLASS& env)
				: m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestRemoveFileAndMoveFile handler2(env);
