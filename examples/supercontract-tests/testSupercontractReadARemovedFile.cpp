...
#define TEST_NAME SupercontractReadARemovedFile
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        class TestHandlerReadARemovedFile {
        ...
        public:
            ...
            TestHandlerReadARemovedFile(ENVIRONMENT_CLASS& env)
            : m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestHandlerReadARemovedFile handlerr(env);
