...
#define TEST_NAME SupercontractCreateAFileInTXTTXTFormatThenTryRemoveFile
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
		...
		public:
			...
			void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
				ASSERT_TRUE(res);
				m_env.removeFsTreeEntry(m_driveKey, RemoveFilesystemEntryRequest{"test.txt.txt", [this](auto res) {
															onFileRemoved(res);
														}});
			}
