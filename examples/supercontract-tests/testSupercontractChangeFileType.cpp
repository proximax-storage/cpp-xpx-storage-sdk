...
#define TEST_NAME SupercontractChangeFileType
...
public:
    ...
    void onDirCreated(std::optional<CreateDirectoriesResponse> res) {
        ASSERT_TRUE(res);
        m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{"tests/test.txt", "moved/test.jpg", [this](auto res) { onFileMoved(res); }});
    }
...
public:
    ...
    void onReceivedFsTree(std::optional<FilesystemResponse> res) {
        ...
        m_env.getAbsolutePath(m_driveKey, AbsolutePathRequest{"moved/test.jpg", [this](auto res) {
                                                                  onReceivedAbsolutePath(res);
                                                              }});
    }
    ...
    void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
        ASSERT_TRUE(res);
        m_env.openFile(m_driveKey, OpenFileRequest{OpenFileMode::READ, "moved/test.jpg", [this](auto res) { onFileOpened(res); }});
    }
