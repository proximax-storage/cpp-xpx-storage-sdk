...
#define TEST_NAME SupercontractRemoveAndWriteBeforeModification
...
class TestHandlerRemoveAndWriteBeforeModification {
...
public:
    ...
    TestHandlerRemoveAndWriteBeforeModification(ENVIRONMENT_CLASS& env)
        : m_env(env) {}
...
TEST(SupercontractTest, TEST_NAME) {
    ...
    TestHandlerRemoveAndWriteBeforeModification handler(env);
