...
#define TEST_NAME SupercontractCreateADirWithTwoFilesAndBothFilesWithEmojiContentThenCreateAnotherDirAndMoveBothFilesInside
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            TestCreateOneDir(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        public:
            ...
            void onFileClosed(std::optional<CloseFileResponse> res) {
                ASSERT_TRUE(res);
                ASSERT_TRUE(res->m_success);
				m_env.openFile(m_driveKey, OpenFileRequest{ OpenFileMode::WRITE, "tests/test2.txt", [this](auto res) { onFileOpened2(res); } });
            }
