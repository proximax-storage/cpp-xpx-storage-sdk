...
#define TEST_NAME SupercontractCreateDirRoot
...
class TestHandlerCreateDirRoot {
...
public:
    ...
    TestHandlerCreateDirRoot(ENVIRONMENT_CLASS& env)
        : m_env(env) {}
...
TEST(SupercontractTest, TEST_NAME) {
    ...
    TestHandlerCreateDirRoot handler(env);
