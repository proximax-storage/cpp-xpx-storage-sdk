...
#define TEST_NAME SupercontractMoveFileToFile
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            TestHandlerMoveToFile(ENVIRONMENT_CLASS& env)
                    : m_env(env) {}
        ...
        public:
            ...
            void onReceivedFsTree(std::optional<FilesystemResponse> res) {
                ...
                ASSERT_TRUE(file.name() == "testing.txt");
                m_env.getAbsolutePath( m_driveKey, FileInfoRequest{"testing.txt", [this]( auto res) {
                    onReceivedAbsolutePath(res);
                }});
            }
            ...
            void onFileClosed(std::optional<CloseFileResponse> res) {
                ASSERT_TRUE(res);
                ASSERT_TRUE(res->m_success);
                m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{"tests/test.txt", "testing.txt/test.txt", [this](auto res) { onFileMoved(res); }});
            ...
            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.openFile(m_driveKey, OpenFileRequest{OpenFileMode::WRITE, "testing.txt", [this](auto res) { onFileOpened(res); }});
            }
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestHandlerMoveToFile handlerm(env);
