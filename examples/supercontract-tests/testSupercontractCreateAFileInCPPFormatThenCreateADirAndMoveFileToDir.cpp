...
#define TEST_NAME SupercontractCreateAFileInCPPFormatThenCreateADirAndMoveFileToDir
    ...
    namespace {
        ...
        public:
            ...
            void onReceivedFsTree(std::optional<FilesystemResponse> res) {
				...
				ASSERT_TRUE(file.name() == "test.cpp");
                m_env.getAbsolutePath(m_driveKey, FileInfoRequest{ "test.cpp", [this](auto res) {
            ...
            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.openFile(m_driveKey, OpenFileRequest{ OpenFileMode::WRITE, "test.cpp", [this](auto res) { onFileOpened(res); } });
            }
		...
		public:
            ...
            void onReceivedFsTree(std::optional<FilesystemResponse> res) {
                ...
                m_env.getAbsolutePath(m_driveKey, FileInfoRequest{ "tests/test.cpp", [this](auto res) {
                                                                          onReceivedAbsolutePath(res);
                                                                      } });
            }
			...
			void onDirCreated(std::optional<CreateDirectoriesResponse> res) {
                ASSERT_TRUE(res);
                m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{ "test.cpp", "tests/test.cpp", [this](auto res) { onFileMoved(res); } });
            }
