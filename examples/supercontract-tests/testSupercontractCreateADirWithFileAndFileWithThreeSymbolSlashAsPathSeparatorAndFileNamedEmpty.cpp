...
#define TEST_NAME SupercontractCreateADirWithFileAndFileWithThreeSymbolSlashAsPathSeparatorAndFileNamedEmpty
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            TestCreateDirWithFile(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestCreateDirWithFile handler(env);
