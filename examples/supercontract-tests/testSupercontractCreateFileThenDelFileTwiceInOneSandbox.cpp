...
#define TEST_NAME SupercontractCreateFileThenDelFileTwiceInOneSandbox
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
		...
		public:
			...
			TestRemoveFileTwice(ENVIRONMENT_CLASS& env)
				: m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestRemoveFileTwice handler2(env);
