...
#define TEST_NAME SupercontractWriteFileTwiceSandbox
...
public:
    ...
    WriteFileTwiceSandbox(ENVIRONMENT_CLASS& env)
        : m_env(env) {}
...
TEST(SupercontractTest, TEST_NAME) {
    ...
    WriteFileTwiceSandbox handler(env);
