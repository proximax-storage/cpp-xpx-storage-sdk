...
#define TEST_NAME SupercontractCreateDirWithTwoFilesEachFileWithSameContentThenUseGetFileSize
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
		...
		public:
			...
			TestGetFolderSize(ENVIRONMENT_CLASS& env)
				: m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestGetFolderSize handler2(env);
