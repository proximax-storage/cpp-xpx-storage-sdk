...
#define TEST_NAME SupercontractCreateAFileInCPPFormatThenREADFile
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
		...
		public:
            ...
            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
				m_env.openFile(m_driveKey, OpenFileRequest{ OpenFileMode::READ, "test.cpp", [this](auto res) { onFileOpened(res); } });
            }
