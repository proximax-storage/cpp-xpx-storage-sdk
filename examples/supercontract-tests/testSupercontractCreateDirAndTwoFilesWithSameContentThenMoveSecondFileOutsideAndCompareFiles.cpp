...
#define TEST_NAME SupercontractCreateDirAndTwoFilesWithSameContentThenMoveSecondFileOutsideAndCompareFiles
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        class TestCreateDirWithTwoFiles {
        ...
        public:
            ...
            TestCreateDirWithTwoFiles(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        class TestMoveAndCompareFileSize {
        ...
        public:
            ...
            TestMoveAndCompareFileSize(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        public:
			...
			void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
				ASSERT_TRUE(res);
				m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{ "tests/test2.txt", "test2.txt", [this](auto res) { onFileMoved(res); } });
			}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestCreateDirWithTwoFiles handler(env);
            ...
            TestMoveAndCompareFileSize handler2(env);
