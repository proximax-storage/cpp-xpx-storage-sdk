...
#define TEST_NAME SupercontractMoveFileInSingleStorageModification
    ...
    namespace {
        ...
        public:
            ...
            void onSandboxModificationsInitiated2(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.createDirectories(m_driveKey, CreateDirectoriesRequest{"moved", [this](auto res) { onDirCreated2(res); }});
          }
