...
#define TEST_NAME SupercontractCreateAFilNamedWithEmojiContentAndPutEmojiContentInFileThenCreateADirAndMoveFileToDir
    ...
    namespace {
        ...
        public:
            ...
            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.openFile(m_driveKey, OpenFileRequest{ OpenFileMode::WRITE, "🧪", [this](auto res) { onFileOpened(res); } });
            }
