...
#define TEST_NAME SupercontractCreateOneDirectoryAndCreateAnotherDirectoryInsideAndMovedFileFromSecondDirectoryToFirstDirectory
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            TestFirstDirectory(ENVIRONMENT_CLASS& env, std::string buffer)
        ...
        public:
            ...
            TestSecondDirectory(ENVIRONMENT_CLASS& env, std::string buffer)
                : m_env(env), m_buffer(buffer) {}
        ...
        public:
            ...
            void onReceivedFsTree(std::optional<FilesystemResponse> res) {
                ...
                for (auto const& [key, val] : files) {
                    ...
                    else if (isFolder(val)) {
                        ASSERT_TRUE(isFolder(val));
                        const auto& folder2 = getFolder(val);
                        ASSERT_TRUE(folder2.name() == "tests2");
                        const auto& files2 = folder2.childs();
                        for (auto const& [key, val] : files2) {
                            ASSERT_TRUE(isFile(val));
                            const auto& file = getFile(val);
                ...
                m_env.getAbsolutePath(m_driveKey, FileInfoRequest{ "tests/tests2/test2.txt", [this](auto res) {
                                                                          onReceivedAbsolutePath(res);
                                                                      } });
            }
            ...
            void onDirCreated(std::optional<CreateDirectoriesResponse> res) {
                ASSERT_TRUE(res);
                m_env.openFile(m_driveKey, OpenFileRequest{ OpenFileMode::WRITE, "tests/tests2/test2.txt", [this](auto res) { onFileOpened(res); } });
            }

            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.createDirectories(m_driveKey, CreateDirectoriesRequest{ "tests/tests2", [this](auto res) { onDirCreated(res); } });
            }
        ...
        class TestMoveFileFromSecondDirectoryToFirstDirectory
        {
        ...
        public:
            ...
            TestMoveFileFromSecondDirectoryToFirstDirectory(ENVIRONMENT_CLASS& env, std::string buffer)
                : m_env(env), m_buffer(buffer) {}
        ...
        public:
            ...
            void onReceivedFsTree(std::optional<FilesystemResponse> res) {
                ...
                m_env.getAbsolutePath(m_driveKey, FileInfoRequest{ "tests/test2.txt", [this](auto res) {
                                                                          onReceivedAbsolutePath(res);
                                                                      } });
            }
            ...
            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{ "tests/tests2/test2.txt", "tests/test2.txt", [this](auto res) { onFileMoved(res); } });
            }
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestFirstDirectory handler(env, "data");
            ...
            TestSecondDirectory handler2(env, "data data");
            ...
            TestMoveFileFromSecondDirectoryToFirstDirectory handler3(env, "data data");
