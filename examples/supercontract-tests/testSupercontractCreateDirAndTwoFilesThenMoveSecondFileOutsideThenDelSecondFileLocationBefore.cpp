...
#define TEST_NAME SupercontractCreateDirAndTwoFilesThenMoveSecondFileOutsideThenDelSecondFileLocationBefore
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
			...
			void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
				ASSERT_TRUE(res);
				m_env.removeFsTreeEntry(m_driveKey, RemoveFilesystemEntryRequest{"tests/test2.txt", [this](auto res) {
															onFileRemoved(res);
														}});
			}
