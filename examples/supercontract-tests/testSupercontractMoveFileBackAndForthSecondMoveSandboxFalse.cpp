...
#define TEST_NAME SupercontractMoveFileBackAndForthSecondMoveSandboxFalse
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            TestMoveFirst(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        public:
            ...
            TestMoveSecond(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        public:
            ...
            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{ "tests/test2.txt", "tests2/test2.txt", [this](auto res) { onFileMoved(res); } });
            }
