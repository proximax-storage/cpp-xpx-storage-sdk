...
#define TEST_NAME SupercontractCreateAndRemoveInASingleSandbox
...
class TestHandlerCreateRemoveSingleSandbox {
...
public:
    ...
    TestHandlerCreateRemoveSingleSandbox(ENVIRONMENT_CLASS& env)
        : m_env(env) {}
...
TEST(SupercontractTest, TEST_NAME) {
    ...
    TestHandlerCreateRemoveSingleSandbox handler(env);
