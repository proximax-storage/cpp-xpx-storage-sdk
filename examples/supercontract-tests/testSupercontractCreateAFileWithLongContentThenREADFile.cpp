...
#define TEST_NAME SupercontractCreateAFileWithLongContentThenREADFile
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            TestCreateAFile(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        public:
            void onReceivedAbsolutePath(std::optional<FileInfoResponse> res) {
                ...
                ASSERT_EQ(content, "");
                p.set_value();
            }
            ...
            void onFileOpened(std::optional<OpenFileResponse> res) {
                ...
                std::string buffer = "";
		...
		public:
			...
			TestREADFile(ENVIRONMENT_CLASS& env)
				: m_env(env) {}
		...
		public:
			...
			void onFileRead(std::optional<ReadFileResponse> res) {
				...
				ASSERT_EQ(actual, "");
				m_env.closeFile(m_driveKey, CloseFileRequest{m_fileId, [this](auto res) {
																 onFileClosed(res);
															 }});
			}
