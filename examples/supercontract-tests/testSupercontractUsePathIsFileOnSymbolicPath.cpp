...
#define TEST_NAME SupercontractUsePathIsFileOnSymbolicPath
    ...
    namespace {
        ...
        public:
            ...
            void onReceivedFsTree(std::optional<FilesystemResponse> res) {
                ...
                ASSERT_TRUE(file.name() == "?@#$&()|;‘’“”<>.txt");
                m_env.getAbsolutePath(m_driveKey, FileInfoRequest{ "?@#$&()|;‘’“”<>.txt", [this](auto res) {
            ...
            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.openFile(m_driveKey, OpenFileRequest{ OpenFileMode::WRITE, "?@#$&()|;‘’“”<>.txt",
		...
		public:
			...
			void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
				ASSERT_TRUE(res);
				m_env.isFile(m_driveKey, PathIsFileRequest{"?@#$&()|;‘’“”<>.txt", [this](auto res) {
                                                       onIsFile(res);
                                                   }});
			}
