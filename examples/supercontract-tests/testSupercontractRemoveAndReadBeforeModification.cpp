...
#define TEST_NAME SupercontractRemoveAndReadBeforeModification
...
class TestHandlerRemoveAndReadBeforeModification {
...
public:
    ...
    TestHandlerRemoveAndReadBeforeModification(ENVIRONMENT_CLASS& env)
        : m_env(env) {}
...
TEST(SupercontractTest, TEST_NAME) {
    ...
    TestHandlerRemoveAndReadBeforeModification handler(env);
