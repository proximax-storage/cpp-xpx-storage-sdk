...
#define TEST_NAME SupercontractCreateDirectoryAndWriteFileThenReadFileThenWriteFile
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            TestFirstDirectory(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        public:
            ...
            TestRead(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
