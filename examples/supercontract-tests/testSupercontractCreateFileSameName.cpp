...
#define TEST_NAME SupercontractCreateFileSameName
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        class TestHandlerCreateFileSameName {
        ...
        public:
            ...
            TestHandlerCreateFileSameName(ENVIRONMENT_CLASS& env)
                    : m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestHandlerCreateFileSameName handler(env);
            ...
            TestHandlerCreateFileSameName handler2(env);
