...
#define TEST_NAME SupercontractUsePathIsFileOnLongPath
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
		...
		public:
			...
			TestIsPathFile(ENVIRONMENT_CLASS& env)
				: m_env(env) {}
		...
		public:
			...
			void onIsFile(std::optional<PathIsFileResponse> res) {
				ASSERT_TRUE(res);
				ASSERT_TRUE(res->m_isFile);
				m_env.applySandboxManualModifications(m_driveKey, ApplySandboxModificationsRequest{true, [this](auto res) {
																									   onAppliedSandboxModifications(res);
																								   }});
			}
			...
			void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
				ASSERT_TRUE(res);
				m_env.isFile(m_driveKey, PathIsFileRequest{".txt", [this](auto res) {
                                                       onIsFile(res);
                                                   }});
			}
