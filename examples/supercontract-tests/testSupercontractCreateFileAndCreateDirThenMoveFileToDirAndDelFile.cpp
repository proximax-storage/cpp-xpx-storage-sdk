...
#define TEST_NAME SupercontractCreateFileAndCreateDirThenMoveFileToDirAndDelFile
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        class TestCreateDirAndMoveFile {
        ...
        public:
            ...
            TestCreateDirAndMoveFile(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        public:
			...
			void onDirCreated(std::optional<CreateDirectoriesResponse> res) {
				ASSERT_TRUE(res);
				m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{ "test.txt", "tests/test.txt", [this](auto res) { onFileMoved(res); } });
			}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestCreateDirAndMoveFile handler2(env);
