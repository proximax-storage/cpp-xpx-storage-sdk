...
#define TEST_NAME SupercontractCreateAFileThenCreateADirWithinFile
    ...
    namespace {
        ...
        public:
            ...
            void onFileClosed(std::optional<CloseFileResponse> res) {
                ASSERT_TRUE(res);
                ASSERT_TRUE(res->m_success);
                m_env.createDirectories(m_driveKey, CreateDirectoriesRequest{ "test.txt/tests", 
            ...
            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.openFile(m_driveKey, OpenFileRequest{ OpenFileMode::WRITE, "test.txt",
