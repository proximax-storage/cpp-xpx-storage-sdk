...
#define TEST_NAME SupercontractUsePathExistOnLongPath
	...
	namespace {
		...
		public:
			...
			void onReceivedFsTree(std::optional<FilesystemResponse> res) {
				...
				ASSERT_TRUE(folder.name() == "");
				...
				m_env.getAbsolutePath( m_driveKey, FileInfoRequest{".txt", [this]( auto res) {
            ...
            void onDirCreated(std::optional<CreateDirectoriesResponse> res) {
                ASSERT_TRUE(res);
                m_env.openFile(m_driveKey, OpenFileRequest{ OpenFileMode::WRITE, ".txt", [this](auto res) { onFileOpened(res); } });
            }

            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.createDirectories(m_driveKey, CreateDirectoriesRequest{ "", [this](auto res) { onDirCreated(res); } });
            }
		...
		public:
			...
			TestPathExist(ENVIRONMENT_CLASS& env)
				: m_env(env) {}
		...
		public:
			...
			void onPathExist(std::optional<PathExistResponse> res) {
				ASSERT_TRUE(res);
				ASSERT_TRUE(res->m_exists);
				m_env.applySandboxManualModifications(m_driveKey, ApplySandboxModificationsRequest{true, [this](auto res) {
															onAppliedSandboxModifications(res);
														}});
			}
			...
			void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
				ASSERT_TRUE(res);
				m_env.pathExist(m_driveKey, PathExistRequest{".txt", [this](auto res) {
                                                         onPathExist(res);
                                                     }});
			}
