...
#define TEST_NAME SupercontractOpenFileInReadModeThenWrite
...
public:
    ...
    TestWriteInReadMode(ENVIRONMENT_CLASS& env)
        : m_env(env) {}
...
TEST(SupercontractTest, TEST_NAME) {
    ...
    TestWriteInReadMode handler2(env);
