...
#define TEST_NAME SupercontractCreateTwoDirWithFileAndFirstDirWithNameSymbolSlashOnlyAndMoveFirstDirInsideSecondDir
    ...
    namespace {
        ...
        public:
            ...
            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.createDirectories(m_driveKey, CreateDirectoriesRequest{ "/", [this](auto res) { onDirCreated(res); } });
            }
        ...
        public:
			...
			void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
				ASSERT_TRUE(res);
				m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{ "/", "tests2//", [this](auto res) { onFileMoved(res); } });
			}
