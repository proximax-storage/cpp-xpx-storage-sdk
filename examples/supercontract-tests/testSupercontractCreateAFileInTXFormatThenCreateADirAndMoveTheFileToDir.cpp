...
#define TEST_NAME SupercontractCreateAFileInTXFormatThenCreateADirAndMoveTheFileToDir
    ...
    namespace {
        ...
        public:
            ...
            void onReceivedFsTree(std::optional<FilesystemResponse> res) {
				...
				ASSERT_TRUE(file.name() == "test.tx");
                m_env.getAbsolutePath(m_driveKey, FileInfoRequest{ "test.tx", [this](auto res) {
            ...
            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.openFile(m_driveKey, OpenFileRequest{ OpenFileMode::WRITE, "test.tx", [this](auto res) { onFileOpened(res); } });
            }
		...
		public:
            ...
            void onReceivedFsTree(std::optional<FilesystemResponse> res) {
                ...
                m_env.getAbsolutePath(m_driveKey, FileInfoRequest{ "tests/test.tx", [this](auto res) {
                                                                          onReceivedAbsolutePath(res);
                                                                      } });
            }
			...
			void onDirCreated(std::optional<CreateDirectoriesResponse> res) {
                ASSERT_TRUE(res);
                m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{ "test.tx", "tests/test.tx", [this](auto res) { onFileMoved(res); } });
            }
