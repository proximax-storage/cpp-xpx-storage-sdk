...
#define TEST_NAME SupercontractCreateTwoFileThenDelTwoFileInTwoStorage
    ...
    namespace {
		...
		class TestRemoveFile {
				...
				public:
					...
					TestRemoveFile(ENVIRONMENT_CLASS& env)
						: m_env(env) {}
				...
				public:
					...
					void onAppliedStorageModifications(std::optional<ApplyStorageModificationsResponse> res) {
						ASSERT_TRUE(res);
						m_env.initiateManualModifications(m_driveKey, InitiateModificationsRequest{ randomByteArray<Hash256>(), [&](auto res) {
							onInitiatedModifications2(res); } });
					}
