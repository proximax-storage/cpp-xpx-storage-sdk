...
#define TEST_NAME SupercontractCreateFileToDirNotExist
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        class TestCreateFileToDirNotExist {
		public:
			std::promise<void> p;
			DriveKey m_driveKey;
			uint64_t m_fileId;
			...
			TestCreateFileToDirNotExist(ENVIRONMENT_CLASS& env)
				: m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestCreateFileToDirNotExist handler(env);
