...
#define TEST_NAME SupercontractCreateTwoDirWithFileAndCreateAnotherFileWithSameNameAsSecondFileAndPutFileInsideFirstDirThenMoveSecondFileToFirstDir
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            TestCreateFileAndMove(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        public:
            ...
            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
                m_env.openFile(m_driveKey, OpenFileRequest{ OpenFileMode::WRITE, "tests/test2.txt", [this](auto res) { onFileOpened(res); } });
            }
        ...
        TEST(SupercontractTest, TEST_NAME) {
			...
			TestCreateFileAndMove handler2(env);
