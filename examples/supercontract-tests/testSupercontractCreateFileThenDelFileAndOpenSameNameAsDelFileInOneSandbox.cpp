...
#define TEST_NAME SupercontractCreateFileThenDelFileAndOpenSameNameAsDelFileInOneSandbox
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
		...
		class TestRemoveFileAndOpenFile {
		...
		public:
			...
			TestRemoveFileAndOpenFile(ENVIRONMENT_CLASS& env)
				: m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestRemoveFileAndOpenFile handler2(env);
