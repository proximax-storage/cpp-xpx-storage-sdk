...
#define TEST_NAME SupercontractCreateTwoDiffDirInOneSandbox
    ...
    namespace {
        ...
        public:
            ...
            void onDirCreated2(std::optional<CreateDirectoriesResponse> res) {
                ASSERT_TRUE(res);
                m_env.openFile(m_driveKey, OpenFileRequest{ OpenFileMode::WRITE, "tests2/test.txt", [this](auto res) { onFileOpened2(res); } });
            }
