...
#define TEST_NAME SupercontractWriteToMovedFileBeforeModification
...
TEST(SupercontractTest, TEST_NAME) {
    ...
    TestHandlerReadMovedFileAssert handlerr1(env, "moved/test.txt", "data data");
