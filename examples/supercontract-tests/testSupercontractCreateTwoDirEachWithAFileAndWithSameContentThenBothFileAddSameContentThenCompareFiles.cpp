...
#define TEST_NAME SupercontractCreateTwoDirEachWithAFileAndWithSameContentThenBothFileAddSameContentThenCompareFiles
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            TestBothFileAddContent(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
			...
			TestBothFileAddContent handler2(env);
