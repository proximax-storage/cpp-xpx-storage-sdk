...
#define TEST_NAME SupercontractCreateTwoDirAndDelFirstFileAndCreateBackDelFile
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            TestCreateBack(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
