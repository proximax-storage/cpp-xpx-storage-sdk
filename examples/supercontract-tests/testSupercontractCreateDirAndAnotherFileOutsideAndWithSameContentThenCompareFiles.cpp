...
#define TEST_NAME SupercontractCreateDirAndAnotherFileOutsideAndWithSameContentThenCompareFiles
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        class TestCreateDirAndAnotherFileOutside {
        ...
        public:
            ...
            TestCreateDirAndAnotherFileOutside(ENVIRONMENT_CLASS& env)
                : m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestCreateDirAndAnotherFileOutside handler(env);
