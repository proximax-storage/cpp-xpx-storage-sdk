...
#define TEST_NAME SupecontractCreateFileThenRemoveFileAndGetFileSize
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        class TestRemoveAndGetFileSize {
		public:
			std::promise<void> p;
			DriveKey m_driveKey;
			uint64_t m_fileId;
			...
			TestRemoveAndGetFileSize(ENVIRONMENT_CLASS& env)
				: m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestRemoveAndGetFileSize handler2(env);
