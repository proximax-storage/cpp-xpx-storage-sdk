...
#define TEST_NAME SupercontractMovefromNonExistingDir
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            void onDirCreated(std::optional<CreateDirectoriesResponse> res) {
                ASSERT_TRUE(res);
                m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{"XXX/test.txt", "moved/test.txt", [this](auto res) { onFileMoved(res); }});
            }
