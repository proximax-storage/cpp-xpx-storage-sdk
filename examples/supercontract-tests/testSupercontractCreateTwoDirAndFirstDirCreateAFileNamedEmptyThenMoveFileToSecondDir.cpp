...
#define TEST_NAME SupercontractCreateTwoDirAndFirstDirCreateAFileNamedEmptyThenMoveFileToSecondDir
    ...
    namespace {
        ...
        public:
            ...
            void onReceivedFsTree(std::optional<FilesystemResponse> res) {
                ...
                m_env.getAbsolutePath(m_driveKey, FileInfoRequest{ "tests2//", [this](auto res) {
                                                                          onReceivedAbsolutePath(res);
                                                                      } });
            }
			...
			void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
				ASSERT_TRUE(res);
				m_env.moveFsTreeEntry(m_driveKey, MoveFilesystemEntryRequest{ "tests//", "tests2//", [this](auto res) { onFileMoved(res); } });
			}
