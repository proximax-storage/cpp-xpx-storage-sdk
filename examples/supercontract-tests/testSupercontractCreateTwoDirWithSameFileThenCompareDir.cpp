...
#define TEST_NAME SupercontractCreateTwoDirWithSameFileThenCompareDir
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
		...
		public:
			...
			TestCompareFolderSize(ENVIRONMENT_CLASS& env)
				: m_env(env) {}
		...
		public:
            ...
            void onSandboxModificationsInitiated(std::optional<InitiateSandboxModificationsResponse> res) {
                ASSERT_TRUE(res);
				m_env.getSize(m_driveKey, FileSizeRequest{"tests", [this](auto res) {
												   onFileSize(res);
											   }});
            }
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestCompareFolderSize handler2(env);
