...
#define TEST_NAME SupercontractRemoveARemovedFile
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        class TestHandlerRemoveSamePath {
        ...
        public:
            ...
            TestHandlerRemoveSamePath(ENVIRONMENT_CLASS& env)
                    : m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            TestHandlerRemoveSamePath handlerr(env);
