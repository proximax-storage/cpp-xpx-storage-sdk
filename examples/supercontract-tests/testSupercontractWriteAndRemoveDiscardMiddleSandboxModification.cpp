...
#define TEST_NAME SupercontractWriteAndRemoveDiscardMiddleSandboxModification
...
#define ENVIRONMENT_CLASS JOIN(TEST_NAME, TestEnvironment)
    ...
    namespace {
        ...
        public:
            ...
            DiscardMiddleSandbox(ENVIRONMENT_CLASS& env)
                    : m_env(env) {}
        ...
        TEST(SupercontractTest, TEST_NAME) {
            ...
            DiscardMiddleSandbox handler(env);
