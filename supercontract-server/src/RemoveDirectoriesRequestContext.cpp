...
namespace sirius::drive::contract
{
    ...
    RemoveDirectoriesRequestContext::RemoveDirectoriesRequestContext(
    ...
    void RemoveDirectoriesRequestContext::processRequest()
    {
        ...
        RemoveDirectoriesRequest request;
        ...
        executor->removeDirectories( driveKey, request );
    }

    void RemoveDirectoriesRequestContext::onCallExecuted( const std::optional<RemoveDirectoriesResponse>& response )
    {
        if ( !*m_serviceIsActive )
        {
            return;
        ...
        storageServer::RemoveDirectoriesResponse msg;
        grpc::Status status;
        if ( response )
        {
