...
private:
    ...
    storage::ReadFileRequest m_request;
    grpc::ServerAsyncResponseWriter<storage::ReadFileResponse> m_responder;

    std::weak_ptr<ModificationsExecutor> m_executor;

public:

    ReadFileRequestContext( storage::StorageServer::AsyncService& service,
