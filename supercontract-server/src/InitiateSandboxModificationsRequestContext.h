...
private:
    ...
    grpc::ServerAsyncResponseWriter<storageServer::InitSandboxResponse> m_responder;

    std::weak_ptr<ModificationsExecutor> m_executor;

public:

    InitiateSandboxModificationsRequestContext( storageServer::StorageServer::AsyncService& service,
