...
class CloseFileRequestContext
        : public RequestContext, public std::enable_shared_from_this<CloseFileRequestContext>
{
...
public:
    ...
    {
        m_service.RequestCloseFile( &m_context, &m_request, &m_responder, &m_completionQueue,
...
private:
    ...
    void onCallExecuted( const std::optional<CloseFileResponse>& response );
};
