...
class EvaluateStorageHashRequestContext
        : public RequestContext, public std::enable_shared_from_this<EvaluateStorageHashRequestContext>
{
...
public:
    ...
    {
        m_service.RequestEvaluateStorageHash( &m_context, &m_request, &m_responder, &m_completionQueue,
...
private:
    ...
    void onCallExecuted( const std::optional<EvaluateStorageHashResponse>& response );
};
