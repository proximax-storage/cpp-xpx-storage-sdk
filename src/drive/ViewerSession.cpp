...
//    }
//
//    virtual void setDownloadChannel( const ReplicatorList&  replicatorList,
//                                     const Hash256&         downloadChannelId,
//                                     std::vector<uint64_t>  alreadyReceivedSize = {} ) override
//    {
//        // TODO setDownloadChannel Is Not a correct function - there should be addCHannel, setChannelReplicators, etc.
//        addDownloadChannel(downloadChannelId);
//        setDownloadChannelReplicators(downloadChannelId, replicatorList);
//    }
//
//    void endWatching()
//    {
