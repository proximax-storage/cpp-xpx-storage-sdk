...
public:
    ...
    void run() override
    {
        ...
        if ( m_drive.m_lastApprovedModification == m_request->m_modificationIdentifier )
        {
        ...
        {
            m_opinionController.setOpinionTrafficTx( m_request->m_modificationIdentifier.array());

            _LOG ( "catching up opinion identifier: " << m_request->m_modificationIdentifier );
        }
