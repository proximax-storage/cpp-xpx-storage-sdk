...
public:
            ...
            m_drive.executeOnBackgroundThread( [this]
                                               {
                                                   ...
                                                   {
                                                       acceptUpperSandboxModifications();
                                                   } else
                                                   {
                                                       discardUpperSandboxModifications();
                                                   }
                                               } );
        } else
        {
    ...
    void computeSandboxHash()
    {
        ...
        m_drive.executeOnSessionThread( [=, this]
                                        {
                                            onStorageHashEvaluated( sandboxRootHash );
                                        } );
    }
